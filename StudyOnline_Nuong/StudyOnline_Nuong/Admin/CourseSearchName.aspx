<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CourseSearchName.aspx.cs" Inherits="StudyOnline_Nuong.Admin.CourseSearchName" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content">
        ...
        <!--  start page-heading -->
        <div id="page-heading">
            <h1>Tìm kiếm khóa học theo tên</h1>
        </div>
        <!-- end page-heading -->
    ...
    <script type="text/javascript">
        ...
        function TimKiem() {
            var tenkhoahoc = $('#txtTimKiem').val();
            //if (p == 13) {
            $.ajax({
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                url: '/Admin/CourseSearchName.aspx/HienThiKhoaHoc',
        ...
        function XoaKhoaHoc(id) {
            $.ajax({
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                url: '/Admin/CourseSearchName.aspx/XoaKhoaHoc',
                data: "{makhoahoc:'" + id + "'}",
                success: function (response) {
