<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CategoryFrontend.aspx.cs" Inherits="StudyOnline_Nuong.Admin.CategoryFrontend" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $.ajax({
                ...
                url: '/Admin/CategoryFrontend.aspx/HienThiChuyenMuc',
                data: "{}",
                dataType: "json",
                async: "true",
