<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CategorySearch.aspx.cs" Inherits="StudyOnline_Nuong.Admin.CategorySearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        function TimKiem() {
            var tenchuyenmuc = $('#txtTimKiem').val();
            $.ajax({
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                url: '/Admin/CategorySearch.aspx/HienThiChuyenMuc',
                data: "{tenchuyenmuc:'" + tenchuyenmuc + "'}",
                dataType: "json",
                async: "true",
        ...
        function XoaChuyenMuc(id) {
            $.ajax({
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                url: '/Admin/CategorySearch.aspx/XoaChuyenMuc',
                data: "{machuyenmuc:'" + id + "'}",
                success: function (response) {
