<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="UserCreate.aspx.cs" Inherits="StudyOnline_Nuong.Admin.UserCreate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function AddUser()
        {
            ...
            var quyenhan = $('input#cbQuyenHan_input').val();

            $.ajax({
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                url: '/Admin/UserCreate.aspx/ThemThanhVien',
                data: "{tenthanhvien:'" + tenthanhvien + "',matkhau:'" + matkhau + "',email:'" + email + "',quyenhan:'" + quyenhan + "',trangthai:'" + trangthai + "',ghichu:'" + ghichu + "'}",
                dataType: "json",
                async: "true",
                                    ...
                                    <td>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                <th valign="top">Quyền hạn:</th>
                                                <td>
                                                    <select id="cbQuyenHan" class="styledselect_form_1">
                                            ...
                                            <tr>
                                                <th>&nbsp;</th>
                                                <td valign="top">
                                                    <input type="button" onclick="AddUser()" class="form-submit" />
