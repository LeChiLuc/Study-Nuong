<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CategoryBackend.aspx.cs" Inherits="StudyOnline_Nuong.Admin.CategoryBackend" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $.ajax({
                ...
                url: '/Admin/CategoryBackend.aspx/HienThiChuyenMuc',
                data: "{}",
                dataType: "json",
                async: "true",
